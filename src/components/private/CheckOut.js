                    ...
                    <div className="bg-white py-5 px-3 w-full">
                        {
                            ...
                            <>
                                <div className="flex justify-end">
                                    <svg onClick={() => setModal(true)} className="w-6 h-6 text-yellow-500 cursor-pointer mb-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" /><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd" /></svg>
                                </div>
                                <div className="flex justify-between mb-2">
                                    ...
                                    <div className="cursor-pointer hover:text-yellow-900 hover:underline font-semibold">
                                        {default_shipping.address.slice(0, 20) + (default_shipping.address.length > 20 ? "..." : "...")}
                                    </div>
                                </div>
                            ...
                            <div onClick={() => setModal(true)} className="font-medium text-lg text-gray-500 hover:text-yellow-900 text-underline flex cursor-pointer align-middle">
                                ...
                                <h2 className="font-bold text-lg mb-2 text-yellow-500">ADD SHIPPING DETAILS</h2>
                            </div>
                        }
