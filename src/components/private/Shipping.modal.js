...
function ShippingModal({ shipping: { shipping, shipping_form, shipping_modal }, setModal, removeShippingWarning, shippingForm, handleInput }) {
    ...
    return (
        <Modal open={shipping_modal} onClose={() => setModal(false)} center closeIcon={closeIcon} classNames={{ modal: 'shipping-modal' }}>
            <div className="flex">
                <svg className="w-6 h-6 text-red-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM15 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"></path><path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1V5a1 1 0 00-1-1H3zM14 7a1 1 0 00-1 1v6.05A2.5 2.5 0 0115.95 16H17a1 1 0 001-1v-5a1 1 0 00-.293-.707l-2-2A1 1 0 0015 7h-1z"></path></svg>
                <h2 className="font-bold text-lg mb-2 text-red-500">Shipping Details</h2>
            </div>
            {
                ...
                shipping.length > 0 ? 
                    ...
                    <div className="text-center my-10 px-20">
                        ...
                        <button onClick={() => shippingForm('add')} className="text-white py-3 px-3 bg-red-500 hover:bg-red-600 font-semibold rounded"> ADD NEW SHIPPING </button>
                    </div>
            }
        </Modal>
    )
