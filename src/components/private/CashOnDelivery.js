                        ...
                        <div className="flex flex-col">
                            {
                                ...
                                <>
                                    <div className="flex justify-between mb-2">
                                        <div className="font-bold text-lg text-red-500">Shipping Details</div>
                            ...
                            {
                                default_shipping !== null ? 
                                <button onClick={placeOrder} className="text-white bg-yellow-500 hover:bg-yellow-600 py-3 px-3 w-full font-semibold align-text-toptext-center rounded">PLACE ORDER</button>
                                :
                                <>
