            ...
            <div className="grid gap-4">                
                <div className="flex justify-center">
                    <div className="py-10 px-10 w-1/2 bg-white rounded shadow-2xl">
                        ...
                        <button onClick={() => history.push('/home/checkout/cash-on-delivery')} className="flex justify-center text-white bg-blue-500 hover:bg-blue-600 py-4 px-3 my-3 w-full font-semibold align-text-toptext-center rounded">
