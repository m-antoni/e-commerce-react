...
function Register({ auth: { name, email, password, confirm_password, loading, user_data: { isAuthenticated } }, handleInputChange, authRegister, clearAuthForm }) {
    ...
    return (
        <div className="flex justify-center pt-32">
            <div className="sm:w-full sm:m-10 md:w-96 p-10 bg-white shadow-2xl">
                <form onSubmit={authRegister}>
                    <h3 className="font-bold pb-2 text-2xl border-b mb-4 text-gray-500">Register</h3>
                    {
                        loading === 'auth' ? <div className="my-20"><Spinner/></div> : 
                        <>
                            <div className="py-2">
                                <div className="font-medium text-gray-500 mb-2">Name:</div>
                            ...
                            <div className="py-2">
                                <div className="font-medium text-gray-500 mb-2">Email:</div>
                            ...
                            <div className="py-2">
                                <div className="font-medium text-gray-500 mb-2">Password:</div>
                            ...
                            <div className="py-2">
                                <div className="font-medium text-gray-500 mb-2">Confirm Password:</div>
                            ...
                            <div className="mt-5">
                                <button className="py-3 px-3 rounded font-bold text-white bg-yellow-500 hover:bg-black w-full btn-register">Register</button>
                            </div>
                        </>
                    }
                </form>
