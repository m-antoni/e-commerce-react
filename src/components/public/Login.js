        ...
        <div className="flex justify-center pt-32">
            <div className="sm:w-full sm:m-10 md:w-96 p-10 bg-white shadow-2xl">
                <form onSubmit={authLogin}>
                    <h3 className="font-bold pb-2 text-2xl border-b mb-4 text-gray-500">Log In</h3>
                    {
                        ...
                        <>
                            ...
                            <div className="mt-5">
                                <button className=" text-white font-bold bg-yellow-500 hover:bg-black py-3 px-3 rounded w-full">Login </button>
                            </div>
                        </>
                    }
                </form>
