            ...
            <div className="container px-5 md:px-20 mx-auto">
                <div className="flex justify-between">
                    <div className="flex cursor-pointer">
                        ...
                        <Link to={token ? '/home' : '/'} className="text-white font-bold border-b-2 border-yellow-500 text-lg">eShop</Link>
                    </div>
                    <div className="w-2/4">
                    ...
                    <ul className="flex items-center">
                        <li className="flex justify-between mr-1 md:mr-2 cursor-pointer"> 
                            ...
                            {
                                token ? <Link to={'/home/products/cart'} className="rounded-full bg-red-900 flex text-white font-bold items-center justify-center h-7 w-7"><span className="text-sm">{cart}</span></Link> : null
                            }
                        </li>
                        <li className="flex cursor-pointer"> 
                            {
                                (token || success) ? 
                                    <div className="flex" onClick={() => setDropdown(!dropdown)}>
                                        <span className="hover:text-white text-yellow-500 mr-1">Michael Antoni</span>
                ...
                <div className="flex justify-end">
                    {
                        dropdown && 
                        <ul className="mt-2">
                            <li><Link className="hover:text-white text-yellow-500 mb-1">Manage Account</Link></li>
                            <li><Link className="hover:text-white text-yellow-500 mb-1">My Purchases</Link></li>
                            <li><Link className="hover:text-white text-yellow-500 mb-1">Log-out</Link></li>
                        </ul>
                    }
                </div>
            </div>
