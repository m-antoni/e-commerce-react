...
function Navbar({ auth: { loading, user_data: { isAuthenticated, user } }, cart, logOut }) {
                ...
                <div className="flex justify-between">
                    ...
                    <ul className="flex items-center">
                        <li className="flex justify-between mr-1 md:mr-2 cursor-pointer"> 
                            ...
                            {
                                isAuthenticated ? <Link to={'/home/products/cart'} className="rounded-full bg-red-900 flex text-white font-bold items-center justify-center h-7 w-7"><span className="text-sm">{cart}</span></Link> : null
                            }
                        </li>
                ...
                <div className="flex justify-end">
                    {
                        ...
                        <ul className="mt-2">
                            ...
                            <li><Link onClick={() => logOut()} className="hover:text-white text-yellow-500 mb-1">Log-out</Link></li>
                        </ul>
                    }
                </div>
            </div>
