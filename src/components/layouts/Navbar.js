                ...
                <div className="flex justify-between">
                    ...
                    <ul className="flex items-center">
                        <li className="flex justify-between mr-1 md:mr-2 cursor-pointer"> 
                            ...
                            {
                                isAuthenticated ? <Link onClick={cart === 0 ? () => SwalError('You have 0 items, please add at least one.') : () => {}} to={cart === 0 ? () => {} : '/home/user/cart'} className="rounded-full bg-red-900 flex text-white font-bold items-center justify-center h-7 w-7"><span className="text-sm">{cart}</span></Link> : null
                            }
                        </li>
